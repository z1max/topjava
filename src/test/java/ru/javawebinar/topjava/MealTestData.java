...
public class MealTestData {
    ...
    public static ResultMatcher contentJson(Meal... expected){
        List<MealWithExceed> expectedWithExceed = getWithExceeded(Arrays.asList(expected), DEFAULT_CALORIES_PER_DAY);
        return content().json(writeValue(expectedWithExceed));
    }

    public static ResultMatcher contentJson(Meal meal){
        return content().json(writeValue(meal));
    }
}
